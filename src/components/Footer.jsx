// src/components/Footer.jsx - Design Moderno
        ...
        <Row className="g-4">
          ...
          <Col lg={2} md={6}>
            ...
            <ul style={{
              ...
              {['Início', 'Estoque', 'Sobre Nós', 'Financiamento', 'Contato'].map((link, index) => (
        ...
        <div style={{
          ...
          <p style={{
            ...
            <span style={{ display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
              Feito com <FaHeart style={{ color: '#dc2626' }} /> para nossos clientes
            </span>
          </p>
        </div>
      </Container>
